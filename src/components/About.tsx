            ...
            >
              <div className="grid grid-cols-2 gap-6">
                {stats.map((stat, index) => (
                  <div
                    key={index}
                    className={`text-center p-6 rounded-2xl bg-white/80 backdrop-blur-sm hover-lift transition-all duration-300 delay-${100 + index * 100} shadow-lg`}
                  >
              ...
              <div className="mt-8 p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-white/40 shadow-lg">
